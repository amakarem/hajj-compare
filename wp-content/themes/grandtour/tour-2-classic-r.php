<?php
/**
 * Template Name: Tour Classic Right Sidebar
...
<div class="inner">
	...
	<div class="element grid classic2_cols animated<?php echo esc_attr($key+1); ?>">
		...
		<div class="one_half gallery2 classic static filterable portfolio_type themeborder" data-id="post-<?php echo esc_attr($key+1); ?>">
			<?php 
