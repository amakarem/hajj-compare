...
function grandtour_register_sidebars() 
{
	...
	if ( function_exists('register_sidebar') )
	    register_sidebar(array('id' => 'single-tour-sidebar', 'name' => 'Single Tour Sidebar', 'description' => 'The default sidebar for single tour page'));
...
add_action( 'widgets_init', 'grandtour_register_sidebars' );
