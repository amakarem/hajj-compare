...
add_action('admin_menu', 'grandtour_shortcode_generator');

function grandtour_shortcode_generator() 
{  
	if ( function_exists('add_meta_box') ) {  
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'grandtour_shortcode_generator_options', 'page', 'normal', 'default' );
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'grandtour_shortcode_generator_options', 'post', 'normal', 'default' );  
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'grandtour_shortcode_generator_options', 'tour', 'normal', 'default' );
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'grandtour_shortcode_generator_options', 'destination', 'normal', 'default' );
	}
}

function grandtour_shortcode_generator_options() {
	...
	grandtour_aasort($shortcodes,"name");
	...
	?>
			...
			<div id="div_<?php echo esc_attr($shortcode_name); ?>" class="rm_section" style="display:none">
				...
				?>
							...
							<?php echo '<strong>'.esc_html($shortcode['title'][$attr]).'</strong>: '.$shortcode['desc'][$attr]; ?><br/><br/>
							...
							?>
									...
									<input type="text" id="<?php echo esc_attr($shortcode_name); ?>_<?php echo esc_attr($attr); ?>" style="width:calc(100% - 32px);" class="attr color_picker" data-attr="<?php echo esc_attr($attr); ?>" readonly/>
