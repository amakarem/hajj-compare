<?php
/**
 * Template Name: Tour 4 Columns Classic
...
<div class="inner">
	...
	<div class="element grid classic4_cols animated<?php echo esc_attr($key+1); ?>">
		...
		<div class="one_fourth gallery4 classic static filterable portfolio_type themeborder" data-id="post-<?php echo esc_attr($key+1); ?>">
			<?php 
			...
			?>		
					...
					<div class="portfolio_info_wrapper">
        			    <a class="tour_link" href="<?php echo esc_url($permalink_url); ?>"><h5><?php the_title(); ?></h5></a>
