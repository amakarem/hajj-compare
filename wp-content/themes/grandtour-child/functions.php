...
function child_theme_scripts_function() {

  wp_enqueue_script( 'custom-child', get_bloginfo( 'stylesheet_directory' ). '/js/custom-child.js');

}

add_action('wp_enqueue_scripts','child_theme_scripts_function');
